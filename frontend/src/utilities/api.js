...
export const addStudent = (id) => api.post(`/studygroups/${id}/add-student`).then(res => res.data)
export const changeForm = (id, form) => api.post(`/studygroups/${id}/change-form`, { form }).then(res => res.data)
